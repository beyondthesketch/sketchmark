...
The `content` directive deals with strings and will coerce all supplied values to strings, but if supply an array to any property used with it, the element will be repeated.
